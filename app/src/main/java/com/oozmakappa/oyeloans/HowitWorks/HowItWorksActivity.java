...
public class HowItWorksActivity extends AppCompatActivity {
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            HowItWorksFragment tp = null;
            switch(position){
                case 0:
                    tp = HowItWorksFragment.newInstance(R.layout.welcome_fragment1);
                    break;
                case 1:
                    tp = HowItWorksFragment.newInstance(R.layout.welcome_fragment2);
                    break;
                case 2:
                    tp = HowItWorksFragment.newInstance(R.layout.welcome_fragment3);
                    break;
                case 3:
                    tp = HowItWorksFragment.newInstance(R.layout.welcome_fragment4);
                    break;
                case 4:
                    tp = HowItWorksFragment.newInstance(R.layout.welcome_fragment5);
                    break;
            }
